...
public class GoogleAdMobController : MonoBehaviour
{
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-2197097542813896/5360369781";
#elif UNITY_IPHONE
    ...
    public void RequestAndLoadInterstitialAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-2197097542813896/6273565005";
#elif UNITY_IPHONE
    ...
    public void RequestAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-2197097542813896/7142394741";
#elif UNITY_IPHONE
        ...
        RewardedAd.Load(adUnitId, CreateAdRequest(),
            (RewardedAd ad, LoadAdError loadError) =>
            {
                ...
                ad.OnAdFullScreenContentClosed += () =>
                {
                    ...
                    GameObject bmObject = GameObject.Find("ButtonManager");
                    ButtonManager bm = bmObject.GetComponent<ButtonManager>();
                    bm.DisplayContinue();
                    OnAdClosedEvent.Invoke();
                };
                ad.OnAdImpressionRecorded += () =>
